...
AGENT = AgentDefinition(
    ...
    allowed_tools=["create_invoice", "get_invoice", "list_invoices", "list_expenses", "create_expense", "create_quotation", "generate_quotation_pdf_tool", "generate_invoice_pdf_tool", "mark_invoice_paid", "generate_invoice_payment_link", "send_quotation_email", "approve_quotation", "reject_quotation", "generate_revenue_report", "generate_expense_report", "generate_sales_pipeline_report", "generate_productivity_report", "generate_forecast_report", "generate_customer_cohort_report"],
    system_prompt=(
